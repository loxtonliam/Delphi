...
begin
  ...
  sSQL1 := 'SELECT DateCreated, ProfileName FROM Profile ORDER BY DateCreated DESC';
...
begin
  ...
  sSQL2 := 'SELECT DatePublished, FORMAT((Likes-Dislikes+Comments)/Views,"CURRENCY") AS Earnings FROM Video,Profile WHERE Profile.ProfileID = Video.ProfileID AND ProfileName = "'
    + sline + '" ';
...
begin
  ...
  sSQL3 := 'SELECT VideoTitle FROM Video WHERE Views >= 1000 AND Dislikes <= 10 ';
...
begin
  ...
  sSQL4 := 'DELETE * FROM Video WHERE YEAR(DatePublished) = 2008';
...
begin
  ...
  sSQL5 := 'UPDATE Profile SET ProfileName = "Tim Horton" WHERE ProfileName = "TimmyTom"';
